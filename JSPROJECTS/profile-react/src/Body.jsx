  ...
  //used to pass info to functional components
    return(
      <>
        ...
        <p class = "">A proud combine enthusiast or maybe a total nutcase</p>
        ...
        <div className="d-flex justify-content-around mb-5"> 
          <ItemCard title="Web design" desc="Here are my react projects I made with Javascript" img={webDesign}/>
        ...
        <p>Contact me! <div className="d-flex justify-content-center gap-2 mb-3">
          <Google/>
          <Youtube/>
          <Linkedin/>
          <Instagram/>
